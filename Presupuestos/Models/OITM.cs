namespace Presupuestos.Models
{
    ...
    public partial class OITM
    {
        ...
        public string U_GrupoReportes { get; set; }

        public string U_GrupoReportes2 { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? U_Ancho_Plg { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? U_Largo_Plg { get; set; }

        [Column(TypeName = "numeric")]
        public decimal? U_Gramaje { get; set; }

        public string U_Familia { get; set; }

        public string U_Formato { get; set; }

        public string U_EstatusInv { get; set; }
    }
}
